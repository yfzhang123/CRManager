...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //7 获取市场活动列表数据-分页-加载分页组件-条件过滤查询
            getActivityListByPageComponentCondition(1,2);
            //8 打开市场活动创建页面
            opencreateActivityModelBtn();
            //9 保存新建的市场活动
            saveActivityBtn();
        })
        ...
        <div class="btn-toolbar" role="toolbar"
            ...
            <div class="btn-group" style="position: relative; top: 18%;">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createActivityModal"
                        id="opencreateActivityModelBtn"><span class="glyphicon glyphicon-plus"></span> 创建
                </button>
        ...
        <div style="position: relative;top: 10px;">
            <table class="table table-hover">
                ...
                <tr style="color: #B3B3B3;">
                    <td><input type="checkbox" id="selectActivityAll"/></td>
                    <td>名称</td>
                    <td>所有者</td>
                    <td>开始日期</td>
                    <td>结束日期</td>
                ...
                <%--<tr class="active">
                    ...
                    <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/activity/toActivityDetail.do';">发传单</a></td>
                    <td>zhangsan</td>
                    <td>2020-10-10</td>
                    <td>2020-10-20</td>
                </tr>
